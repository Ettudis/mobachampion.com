...
$getShaper = $_GET['shaper'];
$theShaperSmall = strtolower($getShaper);
$theShaper = ucfirst($theShaperSmall);
...
{
	$secretShaper = true;
	$shaperData = file_get_contents('../data/__G0xk3yD7Xf.json');
	$shaperDataJSON = json_decode($shaperData);
}
else
{
...
?>
	...
	<div id="pane3" class="tab-pane shaper_area">
		<h4>Starting Items</h4>
			...
			<img src="http://www.moba-champion.com/images/items/Consumable_Potion_VitalityPotion.png" class="mobatip" title="Vitality Potion x3">
		<h4>Core</h4>
		...
		<h4>Defensive</h4>
			<img src="http://www.moba-champion.com/images/items/Legendary_Subjugation.png" class="mobatip" title="Subjugation">		
			<img src="http://www.moba-champion.com/images/items/Legendary_Valor.png" class="mobatip" title="Valor">		
    </div>
