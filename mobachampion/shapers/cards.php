...
if ($theShaperData->hash != "")
{
	$imgPaths = $theShaperData->hash;
}

if ($theShaperData->releasecontrol != "")
{
	...
	foreach ($abilityKeys as $abilityKey)
	{
		...
		{		
			echo '<div class="ability_costs">
						<table>';
						if ($theShaperData->$costType != "")
						{
							echo '<tr><td><b>' . $theShaperData->$costType . ' Cost:</b></td>		<td>' . $theShaperData->$costKey . '</td></tr>';
						}
						else
						{
							echo '<tr><td><b>Cost:</b></td>		<td>' . $theShaperData->$costKey . '</td></tr>';
						}
