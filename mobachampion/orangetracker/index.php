...
<div class="news_post">
<div class="news_header"><div class="news_header_text"><div class="news_title">Orange Tracker</div></div></div>
...
<?php
	...
	$otCount = 'SELECT COUNT(*) FROM otpost GROUP BY otpost.topic';
	...
	if ($page > 1)
	{
		echo '<a href="http://www.moba-champion.com/orangetracker/index.php?page=' . ($page-1) . '"><div class="ot_btn_header_prev ot_btn_header">&larr;</div></a>';
	}
	else
	{
	...
	if ($page == 1)
	{
		echo '<a href="http://www.moba-champion.com/orangetracker/index.php?page=1"><div class="ot_btn_header_prev ot_btn_active">1</div></a>';
	}
	else
	{
		echo '<a href="http://www.moba-champion.com/orangetracker/index.php?page=1"><div class="ot_btn_header">1</div></a>';
	}
	$written++;
	...
	for ($i = $startIndex; $i <= $endIndex; $i++) 
	{
		if ($i > 1 && $i < $totalPages)
		{
			if ($i == $page)
			{
				echo '<a href="http://www.moba-champion.com/orangetracker/index.php?page=' . ($i) . '"><div class="ot_btn_header_prev ot_btn_active">' . $i .'</div></a>';
				$written++;
			}
			else
			{
				echo '<a href="http://www.moba-champion.com/orangetracker/index.php?page=' . ($i) . '"><div class="ot_btn_header_prev ot_btn_header">' . $i .'</div></a>';
				$written++;
			}
		}
		else
	...
	if ($page != $totalPages)
	{
		echo '<a href="http://www.moba-champion.com/orangetracker/index.php?page=' . ($totalPages) . '"><div class="ot_btn_header">' . ($totalPages) . '</div></a>';
		echo '<a href="http://www.moba-champion.com/orangetracker/index.php?page=' . ($page+1) . '"><div class="ot_btn_header_next">&rarr;</div></a>';
	}
	else
	{
		echo '<a href="http://www.moba-champion.com/orangetracker/index.php?page=' . ($totalPages) . '"><div class="ot_btn_header ot_btn_active">' . ($totalPages) . '</div></a>';
