...
{
	echo '<p>You must be logged in to edit a guide. Please log in or <a href="http://moba-champion.com/forum/index.php?action=register">Register</a>.</p>';
	echo '</div> <!-- news -->
	</div> <!-- content -->
...
$guideId = $_GET['id'];
$guide = R::findOne('guide', ' id = ? ',array($guideId));

if (is_null($guide))
{
	echo '<p>Could not find the requested guide.</p>';
	echo '</div> <!-- news -->
	</div> <!-- content -->
...
else if ($guide->author != $context['user']['username'])
{
	echo '<p>This guide is not yours to edit!</p>';
	echo '</div> <!-- news -->
	</div> <!-- content -->
...
<div class="guide_create_info">
	...
	<div class="guide_create_info_right">
		<select class="guide_info_shaper">
			...
			<option value="Desecrator">Desecrator</option>
			...
			<option value="Kindra">Kindra</option>
            <option value="King of Masks">King of Masks</option>
			<option value="Marah">Marah</option>
			<option value="Mikella">Mikella</option>
            ...
            <option value="Salous">Salous</option>
			<option value="Varion">Varion</option>
			<option value="Vex">Vex</option>
            <option value="Viyana">Viyana</option>
			<option value="Voluc">Voluc</option>
            <option value="Zalgus">Zalgus</option>
...
<div class="guide_create_info">
	...
	<div class="guide_create_info_right">
		<select class="guide_info_lane">
			...
			<option value="Solo Lane">Solo Lane</option>
			<option value="Duo Lane">Duo Lane</option>
			<option value="Triple Lane">Triple Lane</option>
...
<div class="guide_section" data-index="2">
	...
	<div class="guide_role_selector">
		...
		<div>Loadout:</div>
		<input class="guide_create_info_loadout_url" type="shaper" name="loadouturl" value="">
	</div>	
</div>
