...
<!--
<div class="news_title clrfix" id="guide_newguide_warning">
  <button type="button" class="close closewhite" data-dismiss="alert">&times;</button>
  <b>Heads Up!</b><span style="margin-right: 24px;">
	We've launched our new Guides system. Older guides are still <a href="http://www.moba-champion.com/guides/legacy.php" class="orangetext">available</a> but will be removed on July 1st. 
</span>
</div>-->
...
<?php 
include('../widgets/createguidewidget.php');
