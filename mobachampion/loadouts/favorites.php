...
<script src="js/loadouts.js?v=1"></script>
	...
	{	
		...
		if (count($favBean) > 0)
		{
			...
			foreach ($favBean as $bean)
			{
				...
				$beanImg = "";
				if (!is_null($bean->shaper) && $bean->shaper != "all")
				{
				...
				{
					echo '<h5>' . $beanImg . ' ' . $bean->title .' (<a href="http://www.moba-champion.com/loadouts/' . $bean->loadout . '">View in Editor</a>)</h5>';
				}
				else
				{
					echo '<h5>' . $beanImg . ' Loadout #' . $bean->loadout . ' (<a href="http://www.moba-champion.com/loadouts/' . $bean->loadout . '">View in Editor</a>)</h5>';
				}
	...
	else if ($context['user']['is_logged'])
	{
		...
		if (count($favBean) > 0)
		{
			...
			foreach ($favBean as $bean)
			{
				...
				if (!is_null($bean->title))
				{
					echo '<h5>' . $bean->title .' (<a href="http://www.moba-champion.com/loadouts/' . $bean->loadout . '">View in Editor</a>)</h5>';
				}
				else
				{
					echo '<h5>Loadout #' . $bean->loadout . ' (<a href="http://www.moba-champion.com/loadouts/' . $bean->loadout . '">View in Editor</a>)</h5>';
				}
					...
					echo '</select>
						   ...
						   <button class="btn btn-danger pull-left removeShaper" data-id="' . $bean->loadout . '" style="margin-left: 8px; height: 32px;"><i class="icon-remove"></i></button>
