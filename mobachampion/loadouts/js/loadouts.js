...
function SaveFavorite()
{
	...
	{	
		...
		{
			$(".loadout_editor_button_favorite").html('FAVORITE <i class="icon-ok"></i>');
		}
		...
		{
			$(".loadout_editor_button_favorite").html('FAVORITE');
		}
	})
	.error(function() 
	{ 
...
{
	var exportPrefix = "http://www.moba-champion.com/loadouts/";
	var exportUrl = "";
