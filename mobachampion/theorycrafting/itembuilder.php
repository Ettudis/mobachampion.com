...
<script type="text/javascript" src="itempaloozabuilder.js?v=1"></script>
<script type="text/javascript" src="itempaloozashopbuyable.js?v=1"></script>
    ...
    <div class="article_content">
        ...
        <div class="news_post" id="loadoutInfoPost">
            ...
            <div class="news_content" id="loadoutInfoContent" style="display: block">
				<div class="article_news">
					...
					Custom Loadout<br/>								
					<b>SHARE URL:</b>&nbsp;<input type="loadout" id="shareLink" class="loadout_url" value="http://www.moba-champion.com/loadouts/1">&nbsp;<input class="loadout_button" type="button" value="Load" onClick="loadLoadout();">
					<br/><br/>
		...
		<div class="news_content" id="advOptionsContent" style="display: none;min-height:0">
			...
			<div class="article_news">
				...
				<div id="GraceActive" style="display: none">
					<p class="bold_text">Grace - Zephyr Aura Passive</p>
					<input id="GraceCheck" type="checkbox" onChange="doCalculations();">&nbsp;Movespeed Bonus Active?
					<br/><br/>
				</div>	
