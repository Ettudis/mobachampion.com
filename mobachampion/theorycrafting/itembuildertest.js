...
var Passives = {
	...
	"Void" : {"textDisplay" : function(I, II, III) {return "<b>Stackable Passive - Void:</b><BR>Reduces any magical damage taken by 10. The reduction is only half as effective against damage over time effects.";}},
	...
	"Vanguard" : {"textDisplay" : function(I, II, III) {
		...
		return "<b>Stackable Passive - Vanguard" + quantityText + ":</b><BR>Your abilities will deal an additional <b class='armor_scaling'>" + toRoundedString(damage,0) + "</b> damage.";
	}},
	...
	"Shock" : {"textDisplay" : function(I, II, III) {
		...
		return "<b>Unique Passive - Shock:</b><BR>Whenever you deal damage to an enemy, you also zap them for an additional <b class='power_scaling'>" + toRoundedString(damage,0) + "</b> magical damage. This effect has a 10 second cooldown.";
	}},
	"Endless Bounty" : {"advDisplay" : function(I, II, III) {
		...
		"flatIncrease" : function(I, II, III) {
			...
			buildStats.resist += stacks*2;
		},
		"textDisplay" : function(I, II, III) {
			return "<b>Unique Passive - Endless Bounty:</b><BR>Every 60 seconds, you gain 20 Health, 2.5 Armor, and 2 Magic Resistance. These bonuses stack up to 10 times.";
	}},
	...
	"Juggernaut" : {"percentIncrease" : function(I, II, III) {
		buildStats.power += 0.01*buildStats.health;
	}},
	...
	"Devotion Aura" : {"textDisplay" : function(I, II, III) {
		var heal = 40 + 0.2*buildStats.power;
	...
	"Plague Host" : {"textDisplay" : function(I, II, III) {
		var damage = 150 + 0.4*buildStats.power;
	...
	"Avatar" : {"advDisplay" : function(I, II, III) {
		...
		"textDisplay" : function(I, II, III) {
			var extraArmor = buildStats.armor;
			var extraResist = buildStats.resist;
			return "<b>Unique Passive - Avatar:</b><BR>When you drop below 50% Health, you gain <b class='armor_scaling'>" + toRoundedString(extraArmor,0) + "</b> Armor, <b class='resist_scaling'>" + toRoundedString(extraResist,0) + "</b> Magic Resistance, and 20% Damage Reduction for 4 seconds. Damaging an enemy extends this effect by 1 seconds, to a maximum of 8 seconds. This effect has a 30 second cooldown.";
	}},
	...
	"Furious Assault" : {"textDisplay" : function(I, II, III) {
		return "<b>Unique Passive - Furious Assault:</b><BR>Your basic attacks and abilities passively penetrate 50% of your target's bonus defenses.";
	}},
	...
	"Windstrike Aura" : {"flatIncrease" : function(I, II, III) {
			buildStats.haste += 20;
		},
		"textDisplay" : function(I, II, III) {
			return "<b>Unique Passive - Windstrike Aura:</b><BR>You and all nearby allied shapers are granted 20 bonus haste and have a 25% chance when attacking of triggering an additional basic attack that deals 50% damage.";
	}},
	"Zephyr Aura" : {"textDisplay" : function(I, II, III) {
...
function doCalculations() {
	...
	buildStats.moveSpeed += 0.38*buildStats.haste;
...
function updateShareUrl() {
	var link = "http://www.moba-champion.com/theorycrafting/test.php";
	link += "?s=" + document.getElementById("shaperMenu").value;
	link += "&i=";
	for (var i = 0; i < 6; i++) {
		if (buildItems[i] != undefined) {
